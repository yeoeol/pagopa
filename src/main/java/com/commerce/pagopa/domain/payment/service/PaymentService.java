...
public class PaymentService {
    ...
    public PaymentService(
            ...
            @Value("${toss.payment.url}") String tossUrl
    ) {
     ...
     */
    @Transactional
    public PaymentResponseDto requestPayment(Long orderId, String orderName, String customerName) {
        ...
        return PaymentResponseDto.of(order.getOrderNumber(), orderName, order.getTotalAmount(), customerName);
    }
